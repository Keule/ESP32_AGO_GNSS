...
static void onEthEvent(WiFiEvent_t event) {
    ...
    case ARDUINO_EVENT_ETH_GOT_IP:
        ...
        s_eth_has_ip = true;
        // Start UDP listener on port 8888 (where AgIO sends data to modules)
        // Reference: Autosteer_UDP_v5.ino line: ether.udpServerListenOnPort(&udpSteerRecv, 8888);
        // AgIO sends steer data, hello, settings etc. to this port.
        ethUDP.begin(AOG_PORT_LISTEN);
        hal_log("ETH: UDP listening on port %u", AOG_PORT_LISTEN);
        break;
